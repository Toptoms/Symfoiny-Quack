 ...
 */
final class Version20190718083059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quack ADD CONSTRAINT FK_83D44F6FF675F31B FOREIGN KEY (author_id) REFERENCES user (id)');
